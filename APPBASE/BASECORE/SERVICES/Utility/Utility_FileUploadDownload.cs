...
namespace APPBASE.Svcutil
{
    public class Utility_FileUploadDownload
    {
        ...
        {
            string vsMsgErr = "";
            List<string> PATH_DEL = new List<string>() {
            "User\\Delete\\", "Employee\\Delete\\", "Employeeuser\\Delete\\",
            "Student\\Delete\\", "Gallery\\Delete\\",
            "Song\\Delete\\"
            };
            ...
            try
            {
                ...
                //sFilename = sFilename.Replace("Employee\\Delete\\", "");
                foreach (var item in PATH_DEL)
                {
                    sFilename = sFilename.Replace(item, "");
                }
