...
namespace APPBASE.Models
{
    ...
    {
        private ProjectVM oViewModel;
        private ProjectDS oDS;
        public List<ValidationMSG_VM> aValidationMSG;

        //Constructor 1
        public Project_Validation(ProjectVM poViewModel)
        {
            this.oViewModel = poViewModel;
            this.oDS = new ProjectDS();
            aValidationMSG = new List<ValidationMSG_VM>();
        } //End Constructor 1
        //Constructor 2
        public Project_Validation(ProjectVM poViewModel, ProjectDS poDS)
        {
            this.oViewModel = poViewModel;
            this.oDS = poDS;
            aValidationMSG = new List<ValidationMSG_VM>();
