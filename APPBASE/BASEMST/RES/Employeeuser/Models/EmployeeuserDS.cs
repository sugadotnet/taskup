...
{
    [Table("VWMST01RES_EMPLOYEEUSER_INFO")]
    public partial class Employeeuser_info
    {
        ...
        public int? EMPUSER_ROLEID { get; set; }
        public string EMPUSER_USERNAME { get; set; }
        public string EMPUSER_PASSWORD { get; set; }
        public string EMPUSER_EMAIL { get; set; }
        public string EMPUSER_USERIMG { get; set; }
        public int? ROLE_MDLEID { get; set; }
        public string ROLE_CD { get; set; }
        public string ROLE_DISPLAYNAME { get; set; }
        public Byte? ROLE_SEQNO { get; set; }
    } //End public partial class Employeeuser_info
