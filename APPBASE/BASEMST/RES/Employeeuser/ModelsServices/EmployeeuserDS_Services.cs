...
{
    public class EmployeeuserDS
    {
        private DBMAINContext db;
        public IQueryable<EmployeeuserVM> FIELD_LOOKUP { get { return this.fieldLookup(); } }
        public IQueryable<EmployeeuserVM> FIELD_INDEX { get { return this.fieldIndex(); } }


        //Constructor 1
        public EmployeeuserDS() { this.db = new DBMAINContext(); } //End Constructor EmployeeuserDS
        //Constructor 2
        public EmployeeuserDS(DBMAINContext poDBMAINContext)
        {
            this.db = poDBMAINContext;
        } //End Constructor
        private IQueryable<EmployeeuserVM> fieldAll()
        {
            IQueryable<EmployeeuserVM> vReturn;

            var oQRY = from tb in this.db.Employeeuser_infos
                       select new EmployeeuserVM
                       {
                           ID = tb.ID,
                           DTA_STS = tb.DTA_STS,
                           NAME = tb.NAME,
                           ...
                           EMPUSER_ID = tb.EMPUSER_ID,
                           EMPUSER_ROLEID = tb.EMPUSER_ROLEID,
                           EMPUSER_USERNAME = tb.EMPUSER_USERNAME,
                           EMPUSER_PASSWORD = tb.EMPUSER_PASSWORD,
                           EMPUSER_EMAIL = tb.EMPUSER_EMAIL,
                           EMPUSER_USERIMG = tb.EMPUSER_USERIMG,
                           ROLE_MDLEID = tb.ROLE_MDLEID,
                           ROLE_CD = tb.ROLE_CD,
                           ROLE_DISPLAYNAME = tb.ROLE_DISPLAYNAME,
                           ROLE_SEQNO = tb.ROLE_SEQNO
                       };
            vReturn = oQRY;

            return vReturn;
        } //End Method
        private IQueryable<EmployeeuserVM> fieldLookup()
        {
            IQueryable<EmployeeuserVM> vReturn;
        ...
        private IQueryable<EmployeeuserVM> fieldIndex()
        {
            IQueryable<EmployeeuserVM> vReturn;
        ...
        public List<EmployeeuserVM> getDatalist(IQueryable<EmployeeuserVM> poFieldsToselect = null)
        {
            if (poFieldsToselect != null) return poFieldsToselect.ToList();
            return this.fieldAll().ToList();
        } //End Method
        public List<EmployeeuserVM> getDatalist_lookup(IQueryable<EmployeeuserVM> poFieldsToselect = null)
        {
            if (poFieldsToselect != null) return poFieldsToselect.ToList();
            return this.fieldLookup().ToList();
        } //End Method
        public EmployeeuserVM getData(int? id, IQueryable<EmployeeuserVM> poFieldsToselect = null)
        {
            IQueryable<EmployeeuserVM> oQRY = null;
