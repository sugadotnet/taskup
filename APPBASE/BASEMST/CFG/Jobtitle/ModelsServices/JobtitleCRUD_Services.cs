...
{
    public class JobtitleCRUD
    {
        private DBMAINContext db;
        private Jobtitle oModel;
        public int? ID { get; set; }
        public Boolean isERR { get; set; }
        public string ERRMSG { get; set; }

        //Constructor 1
        public JobtitleCRUD() { this.db = new DBMAINContext(); } //End public JobtitleCRUD()
        //Constructor 2
        public JobtitleCRUD(DBMAINContext poDB)
        { this.db = poDB; } //End public JobtitleCRUD()
        ...
        public void Delete(int? id)
        {
            try
            {
                this.oModel = this.db.Jobtitles.Find(id);
                this.db.Jobtitles.Remove(this.oModel);
                //this.db.SaveChanges();
                //this.ID = this.oModel.ID;
            } //End try
