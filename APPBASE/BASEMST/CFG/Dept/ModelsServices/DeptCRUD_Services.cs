...
namespace APPBASE.Models
{
    public class DeptCRUD
    {
        ...
        //Constructor 1
        public DeptCRUD() { this.db = new DBMAINContext(); } //End public DeptCRUD()
        //Constructor 2
        public DeptCRUD(DBMAINContext poDB)
        { this.db = poDB; } //End public DeptCRUD()

        public void Create(DeptVM poViewModel)
        {
            try
            {
                this.oModel = new Dept();
                //Map Form Data
                ...
                //Process CRUD
                this.db.Depts.Add(this.oModel);
                //this.db.SaveChanges();
                //this.ID = this.oModel.ID;
            } //End try
            catch (Exception e) { isERR = true; this.ERRMSG = "CRUD - Create: " + e.Message; } //End catch
        } //End public void Create
        public void Update(DeptVM poViewModel)
        {
            try
            {
                this.oModel = this.db.Depts.AsNoTracking().SingleOrDefault(fld => fld.ID == poViewModel.ID);
                //Map Form Data
                this.oModel.InjectFrom(poViewModel);
                //Set Field Header
        ...
        public void Delete(int? id)
        {
            try
            {
                this.oModel = this.db.Depts.Find(id);
                this.db.Depts.Remove(this.oModel);
                //this.db.SaveChanges();
                //this.ID = this.oModel.ID;
            } //End try
